...
------------ | ------------- | ------------- | -------------
**called_from_activity_ids** | **string[]** | Ids of the CallActivities which call this process. | [optional] 
**calling_process_definition_id** | **string** | The id of the calling process definition | [optional] 
