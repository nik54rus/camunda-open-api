...
class ExecutionApi
{
     ...
     * @param  \Swagger\Client\Model\CreateIncidentDto $body body (optional)
     *
     ...
     *
     * @param  string $id The id of the execution to create a new incident for. (required)
     * @param  \Swagger\Client\Model\CreateIncidentDto $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ExecutionDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ExecutionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExecutionWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\ExecutionDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ExecutionDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Get Executions (POST)
     *
     * @param  \Swagger\Client\Model\ExecutionQueryDto $body body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * Get Executions (POST)
     *
     * @param  \Swagger\Client\Model\ExecutionQueryDto $body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @param  \Swagger\Client\Model\ExecutionTriggerDto $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the execution to signal. (required)
     * @param  \Swagger\Client\Model\ExecutionTriggerDto $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
