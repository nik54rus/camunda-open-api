...
class HistoricProcessInstanceApi
{
     ...
     * Delete Async (POST)
     *
     * @param  \Camunda\Client\Model\DeleteHistoricProcessInstancesDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Delete Async (POST)
     *
     * @param  \Camunda\Client\Model\DeleteHistoricProcessInstancesDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\HistoricProcessInstanceDto
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\HistoricProcessInstanceDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHistoricProcessInstanceWithHttpInfo($id)
    {
        $returnType = '\Camunda\Client\Model\HistoricProcessInstanceDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\HistoricProcessInstanceDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\DurationReportResultDto[]
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\DurationReportResultDto[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Camunda\Client\Model\DurationReportResultDto[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\DurationReportResultDto[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\HistoricProcessInstanceQueryDto $body body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\HistoricProcessInstanceQueryDto $body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     *
     * @param  \Camunda\Client\Model\SetRemovalTimeToHistoricProcessInstancesDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\BatchDto
     ...
     * Set Removal Time Async (POST)
     *
     * @param  \Camunda\Client\Model\SetRemovalTimeToHistoricProcessInstancesDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\BatchDto, HTTP status code, HTTP response headers (array of strings)
