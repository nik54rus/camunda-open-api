...
class IncidentApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\IncidentDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\IncidentDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIncidentWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\IncidentDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\IncidentDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
