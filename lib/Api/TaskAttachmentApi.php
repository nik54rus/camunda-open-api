...
class TaskAttachmentApi
{
     ...
     * @return \Camunda\Client\Model\AttachmentDto
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\AttachmentDto, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Camunda\Client\Model\AttachmentDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\AttachmentDto',
