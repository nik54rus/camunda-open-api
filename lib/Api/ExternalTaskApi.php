...
class ExternalTaskApi
{
     ...
     * @param  \Camunda\Client\Model\CompleteExternalTaskDto $body body (optional)
     *
     ...
     *
     * @param  string $id The id of the task to complete. (required)
     * @param  \Camunda\Client\Model\CompleteExternalTaskDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \Camunda\Client\Model\ExtendLockOnExternalTaskDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \Camunda\Client\Model\ExtendLockOnExternalTaskDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * Fetch and Lock
     *
     * @param  \Camunda\Client\Model\FetchExternalTasksDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\LockedExternalTaskDto[]
     */
     ...
     * Fetch and Lock
     *
     * @param  \Camunda\Client\Model\FetchExternalTasksDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\LockedExternalTaskDto[], HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchAndLockWithHttpInfo($body = null)
    {
        $returnType = '\Camunda\Client\Model\LockedExternalTaskDto[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\LockedExternalTaskDto[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\ExternalTaskDto
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\ExternalTaskDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExternalTaskWithHttpInfo($id)
    {
        $returnType = '\Camunda\Client\Model\ExternalTaskDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\ExternalTaskDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Camunda\Client\Model\ExternalTaskBpmnError $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task in which context a BPMN error is reported. (required)
     * @param  \Camunda\Client\Model\ExternalTaskBpmnError $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \Camunda\Client\Model\ExternalTaskFailureDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task to report a failure for. (required)
     * @param  \Camunda\Client\Model\ExternalTaskFailureDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \Camunda\Client\Model\LockExternalTaskDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \Camunda\Client\Model\LockExternalTaskDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\ExternalTaskQueryDto $body body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\ExternalTaskQueryDto $body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     * Set Retries Sync
     *
     * @param  \Camunda\Client\Model\SetRetriesForExternalTasksDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Set Retries Sync
     *
     * @param  \Camunda\Client\Model\SetRetriesForExternalTasksDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
