...
class HistoricJobLogApi
{
     ...
     * @return \Swagger\Client\Model\HistoricJobLogDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\HistoricJobLogDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHistoricJobLogWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\HistoricJobLogDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\HistoricJobLogDto',
     ...
     * Get Job Logs (POST)
     *
     * @param  \Swagger\Client\Model\HistoricJobLogQueryDto $body body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * Get Job Logs (POST)
     *
     * @param  \Swagger\Client\Model\HistoricJobLogQueryDto $body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
