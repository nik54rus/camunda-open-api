...
class TaskApi
{
     ...
     * @param  \Camunda\Client\Model\UserIdDto $body Provide the id of the user that claims the task. (optional)
     *
     ...
     * @param  \Camunda\Client\Model\CompleteTaskDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $id The id of the task to complete. (required)
     * @param  \Camunda\Client\Model\CompleteTaskDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create
     *
     * @param  \Camunda\Client\Model\TaskDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Create
     *
     * @param  \Camunda\Client\Model\TaskDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \Camunda\Client\Model\UserIdDto $body Provide the id of the user that the task should be delegated to. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\TaskDto
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\TaskDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTaskWithHttpInfo($id)
    {
        $returnType = '\Camunda\Client\Model\TaskDto';
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\TaskCountByCandidateGroupResultDto[]
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\TaskCountByCandidateGroupResultDto[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getTaskCountByCandidateGroupWithHttpInfo()
    {
        $returnType = '\Camunda\Client\Model\TaskCountByCandidateGroupResultDto[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\TaskCountByCandidateGroupResultDto[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Camunda\Client\Model\TaskBpmnErrorDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the task a BPMN error is reported for. (required)
     * @param  \Camunda\Client\Model\TaskBpmnErrorDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \Camunda\Client\Model\TaskEscalationDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the task in which context a BPMN escalation is reported. (required)
     * @param  \Camunda\Client\Model\TaskEscalationDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\TaskQueryDto $body body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\TaskQueryDto $body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     * @param  \Camunda\Client\Model\UserIdDto $body Provide the id of the user that will be the assignee of the task. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
