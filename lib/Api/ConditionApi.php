...
class ConditionApi
{
     ...
     * Evaluate
     *
     * @param  \Camunda\Client\Model\EvaluationConditionDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\ProcessInstanceDto[]
     */
    public function evaluateCondition($body = null)
    {
        list($response) = $this->evaluateConditionWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function evaluateConditionAsync($body = null)
    {
        return $this->evaluateConditionAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function evaluateConditionAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Camunda\Client\Model\ProcessInstanceDto[]';
        $request = $this->evaluateConditionRequest($body);
     ...
     */
    protected function evaluateConditionRequest($body = null)
    {
