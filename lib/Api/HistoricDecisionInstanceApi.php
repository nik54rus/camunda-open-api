...
class HistoricDecisionInstanceApi
{
     ...
     * Delete Async (POST)
     *
     * @param  \Camunda\Client\Model\DeleteHistoricDecisionInstancesDto $body body (optional)
     *
     ...
     * Delete Async (POST)
     *
     * @param  \Camunda\Client\Model\DeleteHistoricDecisionInstancesDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\HistoricDecisionInstanceDto
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\HistoricDecisionInstanceDto, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Camunda\Client\Model\HistoricDecisionInstanceDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\HistoricDecisionInstanceDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Camunda\Client\Model\SetRemovalTimeToHistoricDecisionInstancesDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\BatchDto
     ...
     * Set Removal Time Async (POST)
     *
     * @param  \Camunda\Client\Model\SetRemovalTimeToHistoricDecisionInstancesDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\BatchDto, HTTP status code, HTTP response headers (array of strings)
