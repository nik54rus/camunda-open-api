...
class DecisionDefinitionApi
{
     ...
     * @param  \Swagger\Client\Model\EvaluateDecisionDto $body body (optional)
     *
     ...
     *
     * @param  string $id The id of the decision definition to be evaluated. (required)
     * @param  \Swagger\Client\Model\EvaluateDecisionDto $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DecisionDefinitionDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DecisionDefinitionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDecisionDefinitionByIdWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\DecisionDefinitionDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DecisionDefinitionDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DecisionDefinitionDiagramDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DecisionDefinitionDiagramDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDecisionDefinitionDmnXmlByIdWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\DecisionDefinitionDiagramDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DecisionDefinitionDiagramDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Swagger\Client\Model\HistoryTimeToLiveDto $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the decision definition to change history time to live. (required)
     * @param  \Swagger\Client\Model\HistoryTimeToLiveDto $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
