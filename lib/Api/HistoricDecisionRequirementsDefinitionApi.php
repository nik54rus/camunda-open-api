...
class HistoricDecisionRequirementsDefinitionApi
{
     ...
     * @return \Camunda\Client\Model\HistoricDecisionInstanceStatisticsDto[]
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\HistoricDecisionInstanceStatisticsDto[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getDecisionStatisticsWithHttpInfo($id, $decision_instance_id = null)
    {
        $returnType = '\Camunda\Client\Model\HistoricDecisionInstanceStatisticsDto[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\HistoricDecisionInstanceStatisticsDto[]',
