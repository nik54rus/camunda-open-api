...
class ProcessInstanceApi
{
     ...
     *
     * @param  \Camunda\Client\Model\CorrelationMessageAsyncDto $body body (optional)
     *
     ...
     * Correlate Message Async (POST)
     *
     * @param  \Camunda\Client\Model\CorrelationMessageAsyncDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Camunda\Client\Model\DeleteProcessInstancesDto $body **Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\BatchDto
     ...
     * Delete Async (POST)
     *
     * @param  \Camunda\Client\Model\DeleteProcessInstancesDto $body **Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\BatchDto
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\ActivityInstanceDto
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\ActivityInstanceDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActivityInstanceTreeWithHttpInfo($id)
    {
        $returnType = '\Camunda\Client\Model\ActivityInstanceDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\ActivityInstanceDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Camunda\Client\Model\ProcessInstanceModificationDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the process instance to modify. (required)
     * @param  \Camunda\Client\Model\ProcessInstanceModificationDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\ProcessInstanceQueryDto $body body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     * Get List (POST)
     *
     * @param  \Camunda\Client\Model\ProcessInstanceQueryDto $body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     ...
     *
     * @param  \Camunda\Client\Model\SetJobRetriesByProcessDto $body Please note that if both processInstances and processInstanceQuery are provided,
...
**Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)
     ...
     *
     * @param  \Camunda\Client\Model\SetJobRetriesByProcessDto $body Please note that if both processInstances and historicProcessInstanceQuery are provided,
then the resulting execution will be performed on the union of these sets.
...
**Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)
     ...
     *
     * @param  \Camunda\Client\Model\SetVariablesAsyncDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\BatchDto
     ...
     * Set Variables Async (POST)
     *
     * @param  \Camunda\Client\Model\SetVariablesAsyncDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\BatchDto, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Camunda\Client\Model\ProcessInstanceSuspensionStateDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Activate/Suspend In Group
     *
     * @param  \Camunda\Client\Model\ProcessInstanceSuspensionStateDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Camunda\Client\Model\ProcessInstanceSuspensionStateAsyncDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\BatchDto
     ...
     * Activate/Suspend In Batch
     *
     * @param  \Camunda\Client\Model\ProcessInstanceSuspensionStateAsyncDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\BatchDto, HTTP status code, HTTP response headers (array of strings)
