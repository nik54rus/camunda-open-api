...
class HistoryCleanupApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\HistoryCleanupConfigurationDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\HistoryCleanupConfigurationDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHistoryCleanupConfigurationWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\HistoryCleanupConfigurationDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\HistoryCleanupConfigurationDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
