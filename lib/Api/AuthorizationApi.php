...
class AuthorizationApi
{
     ...
     *
     * @param  \Camunda\Client\Model\AuthorizationCreateDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\AuthorizationDto
     */
     ...
     * Create a New Authorization
     *
     * @param  \Camunda\Client\Model\AuthorizationCreateDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\AuthorizationDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAuthorizationWithHttpInfo($body = null)
    {
        $returnType = '\Camunda\Client\Model\AuthorizationDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\AuthorizationDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Camunda\Client\Model\AuthorizationCheckResultDto
     */
     ...
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Camunda\Client\Model\AuthorizationCheckResultDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function isUserAuthorizedWithHttpInfo($permission_name, $resource_name, $resource_type, $resource_id = null, $user_id = null)
    {
        $returnType = '\Camunda\Client\Model\AuthorizationCheckResultDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Camunda\Client\Model\AuthorizationCheckResultDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Camunda\Client\Model\AuthorizationUpdateDto $body body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the authorization to be updated. (required)
     * @param  \Camunda\Client\Model\AuthorizationUpdateDto $body (optional)
     *
     * @throws \Camunda\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
