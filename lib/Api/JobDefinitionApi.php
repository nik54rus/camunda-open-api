...
class JobDefinitionApi
{
     ...
     * @return \Swagger\Client\Model\JobDefinitionDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\JobDefinitionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getJobDefinitionWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\JobDefinitionDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\JobDefinitionDto',
     ...
     *
     * @param  \Swagger\Client\Model\JobDefinitionQueryDto $body body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * Get Job Definitions (POST)
     *
     * @param  \Swagger\Client\Model\JobDefinitionQueryDto $body (optional)
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @param  \Swagger\Client\Model\JobDefinitionPriorityDto $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the job definition to be updated. (required)
     * @param  \Swagger\Client\Model\JobDefinitionPriorityDto $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \Swagger\Client\Model\JobDefinitionSuspensionStateDto $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the job definition to activate or suspend. (required)
     * @param  \Swagger\Client\Model\JobDefinitionSuspensionStateDto $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \Swagger\Client\Model\JobDefinitionsSuspensionStateDto $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Activate/Suspend Job Definitions
     *
     * @param  \Swagger\Client\Model\JobDefinitionsSuspensionStateDto $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
