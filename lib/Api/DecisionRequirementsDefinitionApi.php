...
class DecisionRequirementsDefinitionApi
{
     ...
     * @return \Swagger\Client\Model\DecisionRequirementsDefinitionDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DecisionRequirementsDefinitionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDecisionRequirementsDefinitionByIdWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\DecisionRequirementsDefinitionDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DecisionRequirementsDefinitionDto',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\DecisionRequirementsDefinitionXmlDto
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\DecisionRequirementsDefinitionXmlDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDecisionRequirementsDefinitionDmnXmlByIdWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\DecisionRequirementsDefinitionXmlDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\DecisionRequirementsDefinitionXmlDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
