...
class MissingAuthorizationDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MissingAuthorizationDto';
     ...
     *
     * @param string $permission_name The permission name that the user is missing.
     *
     * @return $this
     */
     ...
     * Sets resource_name
     *
     * @param string $resource_name The name of the resource that the user is missing permission for.
     *
     * @return $this
     */
     ...
     * Sets resource_id
     *
     * @param string $resource_id The id of the resource that the user is missing permission for.
     *
     * @return $this
     */
