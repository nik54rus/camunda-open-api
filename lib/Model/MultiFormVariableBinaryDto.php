...
class MultiFormVariableBinaryDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'MultiFormVariableBinaryDto';
     ...
     * Sets data
     *
     * @param string $data The binary data to be set. For File variables, this multipart can contain the filename, binary value and MIME type of the file variable to be set Only the filename is mandatory.
     *
     * @return $this
     */
     ...
     * Sets value_type
     *
     * @param string $value_type The name of the variable type. Either Bytes for a byte array variable or File for a file variable.
     *
     * @return $this
     */
