...
class MigrationPlanGenerationDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'MigrationPlanGenerationDto';
     ...
     * Sets variables
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $variables A map of variables which will be set into the process instances' scope. Each key is a variable name and each value a JSON variable value object.
     *
     * @return $this
     */
