...
class MigrationPlanDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'MigrationPlanDto';
    ...
    protected static $CamundaTypes = [
        ...
        'instructions' => '\Camunda\Client\Model\MigrationInstructionDto[]',
     ...
     * Gets instructions
     *
     * @return \Camunda\Client\Model\MigrationInstructionDto[]
     */
     ...
     * Sets instructions
     *
     * @param \Camunda\Client\Model\MigrationInstructionDto[] $instructions A list of migration instructions which map equal activities. Each migration instruction is a JSON object with the following properties:
     *
     * @return $this
     */
