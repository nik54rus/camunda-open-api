...
class SchemaLogEntryDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'SchemaLogEntryDto';
     ...
     * Sets id
     *
     * @param string $id The id of the schema log entry.
     *
     * @return $this
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime $timestamp The date and time of the schema update.
     *
     * @return $this
     */
