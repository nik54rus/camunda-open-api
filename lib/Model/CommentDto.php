...
class CommentDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'CommentDto';
     ...
     * Sets id
     *
     * @param string $id The id of the task comment.
     *
     * @return $this
     */
     ...
     * Sets user_id
     *
     * @param string $user_id The id of the user who created the comment.
     *
     * @return $this
     */
     ...
     * Sets task_id
     *
     * @param string $task_id The id of the task to which the comment belongs.
     *
     * @return $this
     */
     ...
     *
     * @param string $process_instance_id The id of the process instance the comment is related to.
     *
     * @return $this
     */
     ...
     * Sets time
     *
     * @param \DateTime $time The time when the comment was created. [Default format]($(docsUrl)/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return $this
     */
     ...
     * Sets removal_time
     *
     * @param \DateTime $removal_time The time after which the comment should be removed by the History Cleanup job. [Default format]($(docsUrl)/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return $this
     */
