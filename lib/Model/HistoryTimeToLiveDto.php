...
class HistoryTimeToLiveDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HistoryTimeToLiveDto';
     ...
     *
     * @param int $history_time_to_live New value for historyTimeToLive field of the definition. Can be `null` if `enforceHistoryTimeToLive` is configured to `false`. Cannot be negative.
     *
     * @return $this
     */
