...
class StartProcessInstanceFormDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StartProcessInstanceFormDto';
     ...
     * Sets business_key
     *
     * @param string $business_key The business key the process instance is to be initialized with. The business key uniquely identifies the process instance in the context of the given process definition.
     *
     * @return $this
     */
