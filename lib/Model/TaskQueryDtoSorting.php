...
class TaskQueryDtoSorting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'TaskQueryDto_sorting';
    ...
    protected static $CamundaTypes = [
        'sort_by' => 'string',
        'sort_order' => 'string',
        'parameters' => '\Camunda\Client\Model\SortTaskQueryParametersDto'
    ];
     ...
     * Gets parameters
     *
     * @return \Camunda\Client\Model\SortTaskQueryParametersDto
     */
     ...
     * Sets parameters
     *
     * @param \Camunda\Client\Model\SortTaskQueryParametersDto $parameters parameters
     *
     * @return $this
     */
