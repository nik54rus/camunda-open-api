 ...
 * @link     https://github.com/nik54rus/camunda-open-api
 */
class CheckPasswordPolicyRuleDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'CheckPasswordPolicyRuleDto';
     ...
     * Sets valid
     *
     * @param bool $valid `true` if the password is compliant with this rule, otherwise `false`.
     *
     * @return $this
     */
