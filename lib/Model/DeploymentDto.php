...
class DeploymentDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeploymentDto';
     ...
     * Sets tenant_id
     *
     * @param string $tenant_id The tenant id of the deployment.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $deployment_time The time when the deployment was created.
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string $source The source of the deployment.
     *
     * @return $this
     */
