...
class IncidentStatisticsResultDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'IncidentStatisticsResultDto';
     ...
     * Sets incident_type
     *
     * @param string $incident_type The type of the incident the number of incidents is aggregated for. See the [User Guide](https://docs.camunda.org/manual/7.21/user-guide/process-engine/incidents/#incident-types) for a list of incident types.
     *
     * @return $this
     */
     ...
     * Sets incident_count
     *
     * @param int $incident_count The total number of incidents for the corresponding incident type.
     *
     * @return $this
     */
