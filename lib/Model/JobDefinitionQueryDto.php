...
class JobDefinitionQueryDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'JobDefinitionQueryDto';
    ...
    protected static $CamundaTypes = [
        ...
        'sorting' => '\Camunda\Client\Model\JobDefinitionQueryDtoSorting[]'
    ];
     ...
     * Gets sorting
     *
     * @return \Camunda\Client\Model\JobDefinitionQueryDtoSorting[]
     */
