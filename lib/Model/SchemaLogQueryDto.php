...
class SchemaLogQueryDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'SchemaLogQueryDto';
    ...
    protected static $CamundaTypes = [
        'version' => 'string',
        'sorting' => '\Camunda\Client\Model\SchemaLogQueryDtoSorting[]'
    ];
     ...
     * Gets sorting
     *
     * @return \Camunda\Client\Model\SchemaLogQueryDtoSorting[]
     */
     ...
     * Sets sorting
     *
     * @param \Camunda\Client\Model\SchemaLogQueryDtoSorting[] $sorting A JSON array of criteria to sort the result by. Each element of the array is                       a JSON object that specifies one ordering. The position in the array                       identifies the rank of an ordering, i.e., whether it is primary, secondary,                       etc.
     *
     * @return $this
     */
