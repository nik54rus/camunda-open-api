 ...
 * @link     https://github.com/nik54rus/camunda-open-api
 */
class JobDuedateDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'JobDuedateDto';
     ...
     * Sets duedate
     *
     * @param \DateTime $duedate The date to set when the job has the next execution.
     *
     * @return $this
     */
