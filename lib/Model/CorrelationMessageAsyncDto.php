...
class CorrelationMessageAsyncDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CorrelationMessageAsyncDto';
     ...
     * Sets variables
     *
     * @param map[string,\Swagger\Client\Model\VariableValueDto] $variables All variables the operation will set in the root scope of the process instances the message is correlated to.
     *
     * @return $this
     */
