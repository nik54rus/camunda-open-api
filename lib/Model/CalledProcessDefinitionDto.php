...
/**
 * CalledProcessDefinitionDto Class Doc Comment
 *
 * @category Class
 * @package  Camunda\Client
 * @author   Nik54rus
 * @link     https://github.com/nik54rus/camunda-open-api
 */
class CalledProcessDefinitionDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'CalledProcessDefinitionDto';
    ...
    protected static $CamundaTypes = [
        'called_from_activity_ids' => 'string[]',
        'calling_process_definition_id' => 'string',
        'id' => 'string',
        'key' => 'string',
        'category' => 'string',
        'description' => 'string',
    ...
    protected static $CamundaFormats = [
        'called_from_activity_ids' => null,
        'calling_process_definition_id' => null,
        'id' => null,
        'key' => null,
        'category' => null,
        'description' => null,
    ...
    protected static $setters = [
        'called_from_activity_ids' => 'setCalledFromActivityIds',
        'calling_process_definition_id' => 'setCallingProcessDefinitionId',
        'id' => 'setId',
        'key' => 'setKey',
    ...
    protected static $getters = [
        'called_from_activity_ids' => 'getCalledFromActivityIds',
        'calling_process_definition_id' => 'getCallingProcessDefinitionId',
        'id' => 'getId',
        'key' => 'getKey',
    ...
    {
        $this->container['called_from_activity_ids'] = isset($data['called_from_activity_ids']) ? $data['called_from_activity_ids'] : null;
        $this->container['calling_process_definition_id'] = isset($data['calling_process_definition_id']) ? $data['calling_process_definition_id'] : null;
    ...
    /**
     * Gets called_from_activity_ids
     *
     * @return string[]
     */
    public function getCalledFromActivityIds()
    {
        return $this->container['called_from_activity_ids'];
    }

    /**
     * Sets called_from_activity_ids
     *
     * @param string[] $called_from_activity_ids Ids of the CallActivities which call this process.
     *
     * @return $this
     */
    public function setCalledFromActivityIds($called_from_activity_ids)
    {
        $this->container['called_from_activity_ids'] = $called_from_activity_ids;

        return $this;
    }

    /**
     * Gets calling_process_definition_id
     *
     * @return string
     */
    public function getCallingProcessDefinitionId()
    {
        return $this->container['calling_process_definition_id'];
    }

    /**
     * Sets calling_process_definition_id
     *
     * @param string $calling_process_definition_id The id of the calling process definition
     *
     * @return $this
     */
    public function setCallingProcessDefinitionId($calling_process_definition_id)
    {
        $this->container['calling_process_definition_id'] = $calling_process_definition_id;
