...
/**
 * HistoricExternalTaskLogQueryDtoSorting Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HistoricExternalTaskLogQueryDtoSorting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HistoricExternalTaskLogQueryDto_sorting';
    ...
    const SORT_BY_EXTERNAL_TASK_ID = 'externalTaskId';
    const SORT_BY_TOPIC_NAME = 'topicName';
    const SORT_BY_WORKER_ID = 'workerId';
    const SORT_BY_RETRIES = 'retries';
    ...
    public function getSortByAllowableValues()
    {
        return [
            ...
            self::SORT_BY_EXTERNAL_TASK_ID,
            self::SORT_BY_TOPIC_NAME,
            self::SORT_BY_WORKER_ID,
            self::SORT_BY_RETRIES,
