...
class TriggerVariableValueDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TriggerVariableValueDto';
     ...
     * Sets local
     *
     * @param bool $local Indicates whether the variable should be a local variable or not. If set to true, the variable becomes a local variable of the execution entering the target activity.
     *
     * @return $this
     */
