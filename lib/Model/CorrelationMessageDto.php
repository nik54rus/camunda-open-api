...
class CorrelationMessageDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'CorrelationMessageDto';
    ...
    protected static $CamundaTypes = [
        ...
        'correlation_keys' => 'map[string,\Camunda\Client\Model\VariableValueDto]',
        'local_correlation_keys' => 'map[string,\Camunda\Client\Model\VariableValueDto]',
        'process_variables' => 'map[string,\Camunda\Client\Model\VariableValueDto]',
        'process_variables_local' => 'map[string,\Camunda\Client\Model\VariableValueDto]',
        'process_variables_to_triggered_scope' => 'map[string,\Camunda\Client\Model\VariableValueDto]',
        'all' => 'bool',
        'result_enabled' => 'bool',
     ...
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $process_variables A map of variables that is injected into the triggered execution or process instance after the message has been delivered. Each key is a variable name and each value a JSON variable value object with the following properties.
     *
     * @return $this
     */
     ...
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $process_variables_local A map of local variables that is injected into the execution waiting on the message. Each key is a variable name and each value a JSON variable value object with the following properties.
     *
     * @return $this
     */
     ...
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $process_variables_to_triggered_scope A map of variables that is injected into the new scope triggered by message correlation. Each key is a variable name and each value a JSON variable value object with the following properties.
     *
     * @return $this
     */
