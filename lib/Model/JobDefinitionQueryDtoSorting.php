...
/**
 * JobDefinitionQueryDtoSorting Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class JobDefinitionQueryDtoSorting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JobDefinitionQueryDto_sorting';
    ...
    const SORT_BY_JOB_TYPE = 'jobType';
    const SORT_BY_JOB_CONFIGURATION = 'jobConfiguration';
    ...
    public function getSortByAllowableValues()
    {
        return [
            ...
            self::SORT_BY_JOB_TYPE,
            self::SORT_BY_JOB_CONFIGURATION,
