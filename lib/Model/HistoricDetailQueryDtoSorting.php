...
/**
 * HistoricDetailQueryDtoSorting Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HistoricDetailQueryDtoSorting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HistoricDetailQueryDto_sorting';
    ...
    const SORT_BY_VARIABLE_REVISION = 'variableRevision';
    const SORT_BY_FORM_PROPERTY_ID = 'formPropertyId';
    ...
    public function getSortByAllowableValues()
    {
        return [
            ...
            self::SORT_BY_VARIABLE_REVISION,
            self::SORT_BY_FORM_PROPERTY_ID,
            self::SORT_BY_TIME,
