...
/**
 * TelemetryCountDto Class Doc Comment
 *
 * @category Class
 * @package  Camunda\Client
 * @author   Nik54rus
 * @link     https://github.com/nik54rus/camunda-open-api
 */
class TelemetryCountDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'TelemetryCountDto';
     ...
     * Sets count
     *
     * @param int $count An integer value representing the count for this metric.
     *
     * @return $this
     */
