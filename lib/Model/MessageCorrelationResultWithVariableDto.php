...
class MessageCorrelationResultWithVariableDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageCorrelationResultWithVariableDto';
    ...
    protected static $swaggerTypes = [
        'result_type' => 'string',
        'process_instance' => '\Swagger\Client\Model\ProcessInstanceDto',
        'execution' => '\Swagger\Client\Model\ExecutionDto',
     ...
     *
     * @param \Swagger\Client\Model\ProcessInstanceDto $process_instance process_instance
     *
     * @return $this
     */
     ...
     * Sets execution
     *
     * @param \Swagger\Client\Model\ExecutionDto $execution execution
     *
     * @return $this
     */
     ...
     * Sets variables
     *
     * @param map[string,\Swagger\Client\Model\VariableValueDto] $variables This property is returned if the `variablesInResultEnabled` is set to `true`. Contains a list of the process variables.
     *
     * @return $this
     */
