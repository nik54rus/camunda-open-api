...
class ProcessInstanceQueryDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'ProcessInstanceQueryDto';
    ...
    protected static $CamundaTypes = [
        ...
        'or_queries' => '\Camunda\Client\Model\ProcessInstanceQueryDto[]',
        'sorting' => '\Camunda\Client\Model\ProcessInstanceQueryDtoSorting[]'
    ];
     ...
     * Gets sorting
     *
     * @return \Camunda\Client\Model\ProcessInstanceQueryDtoSorting[]
     */
     ...
     * Sets sorting
     *
     * @param \Camunda\Client\Model\ProcessInstanceQueryDtoSorting[] $sorting Apply sorting of the result
     *
     * @return $this
     */
