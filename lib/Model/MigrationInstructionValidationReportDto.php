...
/**
 * MigrationInstructionValidationReportDto Class Doc Comment
 *
 * @category Class
 * @package  Camunda\Client
 * @author   Nik54rus
 * @link     https://github.com/nik54rus/camunda-open-api
 */
class MigrationInstructionValidationReportDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'MigrationInstructionValidationReportDto';
    ...
    protected static $CamundaTypes = [
        'instruction' => '\Camunda\Client\Model\MigrationInstructionDto',
        'failures' => 'string[]'
    ];
     ...
     * Sets instruction
     *
     * @param \Camunda\Client\Model\MigrationInstructionDto $instruction instruction
     *
     * @return $this
     */
     ...
     * Sets failures
     *
     * @param string[] $failures A list of instruction validation report messages.
     *
     * @return $this
     */
