...
/**
 * HistoricTaskInstanceQueryDtoSorting Class Doc Comment
 *
 * @category Class
 * @package  Camunda\Client
 * @author   Nik54rus
 * @link     https://github.com/nik54rus/camunda-open-api
 */
class HistoricTaskInstanceQueryDtoSorting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'HistoricTaskInstanceQueryDto_sorting';
    ...
    const SORT_BY_TASK_NAME = 'taskName';
    const SORT_BY_TASK_DESCRIPTION = 'taskDescription';
    ...
    const SORT_BY_DELETE_REASON = 'deleteReason';
    const SORT_BY_TASK_DEFINITION_KEY = 'taskDefinitionKey';
    const SORT_BY_PRIORITY = 'priority';
    const SORT_BY_CASE_DEFINITION_ID = 'caseDefinitionId';
    ...
    public function getSortByAllowableValues()
    {
        return [
            ...
            self::SORT_BY_TASK_NAME,
            self::SORT_BY_TASK_DESCRIPTION,
            self::SORT_BY_ASSIGNEE,
            self::SORT_BY_OWNER,
            self::SORT_BY_DUE_DATE,
            self::SORT_BY_FOLLOW_UP_DATE,
            self::SORT_BY_DELETE_REASON,
            self::SORT_BY_TASK_DEFINITION_KEY,
            self::SORT_BY_PRIORITY,
            self::SORT_BY_CASE_DEFINITION_ID,
