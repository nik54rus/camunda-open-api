...
class SetVariablesAsyncDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SetVariablesAsyncDto';
     ...
     * Sets variables
     *
     * @param map[string,\Swagger\Client\Model\VariableValueDto] $variables A variables the operation will set in the root scope of the process instances.
     *
     * @return $this
     */
