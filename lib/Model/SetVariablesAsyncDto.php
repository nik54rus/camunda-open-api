 ...
 * @link     https://github.com/nik54rus/camunda-open-api
 */
class SetVariablesAsyncDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'SetVariablesAsyncDto';
     ...
     * Sets variables
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $variables A variables the operation will set in the root scope of the process instances.
     *
     * @return $this
     */
