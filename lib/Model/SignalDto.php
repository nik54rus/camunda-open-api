...
class SignalDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'SignalDto';
     ...
     * Sets variables
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $variables A JSON object containing variable key-value pairs. Each key is a variable name and each value a JSON variable value object.
     *
     * @return $this
     */
