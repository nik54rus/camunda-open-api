...
class ProcessInstanceWithVariablesDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcessInstanceWithVariablesDto';
     ...
     * Sets variables
     *
     * @param map[string,\Swagger\Client\Model\VariableValueDto] $variables The id of the process instance.
     *
     * @return $this
     */
