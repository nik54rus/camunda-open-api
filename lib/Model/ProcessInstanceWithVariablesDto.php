...
class ProcessInstanceWithVariablesDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'ProcessInstanceWithVariablesDto';
     ...
     * Sets variables
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $variables The id of the process instance.
     *
     * @return $this
     */
