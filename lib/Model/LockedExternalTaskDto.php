...
class LockedExternalTaskDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $CamundaModelName = 'LockedExternalTaskDto';
     ...
     * Sets variables
     *
     * @param map[string,\Camunda\Client\Model\VariableValueDto] $variables A JSON object containing a property for each of the requested variables. The key is the variable name, the value is a JSON object of serialized variable values with the following properties:
     *
     * @return $this
     */
